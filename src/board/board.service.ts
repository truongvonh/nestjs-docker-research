...
export class BoardService {
  constructor(@InjectModel(BoardModel.name) private boardModel: Model<BoardModel>) {}

  public async checkExistBoardById(boardId: string | Types.ObjectId): Promise<BoardModel> {
